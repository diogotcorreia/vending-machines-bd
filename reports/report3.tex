...
o utilizador pode recorrer ao campo de \textit{input} de \textit{queries} no fim do menu principal
...
Para a primeira \textit{query}, decidimos criar índices em dois atributos da relação \texttt{responsible\_for}:
...
Para a segunda \textit{query}, optámos por criar três índices: dois na relação
