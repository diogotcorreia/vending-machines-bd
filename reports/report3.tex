...
\begin{enumerate}
  \item \textbf{Inserir e remover Categorias e Sub-Categorias.}
        ...
        da base de dados, o utilizador, partindo do menu principal, pode selecionar qualquer
        uma das opções entre \texttt{Category}, \texttt{Simple Category} e \texttt{Super Category}.
        De seguida:
