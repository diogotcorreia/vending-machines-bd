...
VALUES ('Bolachas', '3', 'ivm-1', 'fizz'),
    ...
    ('Fruta', '1', 'ivm-7', 'lightyear'),
    ('Sumo de Laranja Natural', '1', 'ivm-8', 'lightyear'),
    ('Bolachas', '2', 'ivm-8', 'lightyear'),
    ('Bolachas de Chocolate', '2', 'ivm-9', 'lightyear'),
    ('Fruta', '2', 'ivm-10', 'lightyear'),
    ('Sumo de Laranja Natural', '2', 'ivm-10', 'lightyear');
----------------------
-- Replenishment Event
----------------------
